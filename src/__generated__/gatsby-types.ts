...
type BlogPostQueryQuery = { readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<(
      ...
      & { readonly image: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<Pick<ImageSharpFluid, 'src' | 'sizes'>> }> }> }
    )> }
  )> };
