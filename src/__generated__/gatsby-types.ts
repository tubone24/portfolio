...
type IndexQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        ...
        & { readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<(
          ...
          & { readonly image: Maybe<{ readonly childImageSharp: Maybe<{ readonly sizes: Maybe<GatsbyImageSharpSizesFragment> }> }> }
        )> }
      ) }> }, readonly allImageSharp: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<File, 'id'>
        & { readonly childImageSharp: Maybe<{ readonly sizes: Maybe<GatsbyImageSharpSizes_tracedSVGFragment> }> }
      ) }> }, readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly childImageSharp: Maybe<{ readonly sizes: Maybe<GatsbyImageSharpSizes_tracedSVGFragment> }> } }> } };
